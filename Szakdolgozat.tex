...
\definecolor{myblue}{HTML}{2679fe}
...
\lstset{
  ...
  emph            =[4]{require_once,require_login},
...
\input{Fejezetek/Feladatkiiras}
\input{Fejezetek/TartalmiOsszefoglalo}
\input{Fejezetek/Bevezeto}
\input{Fejezetek/Elmelet}
\input{Fejezetek/Generator}
\input{Fejezetek/Solver}
\input{Fejezetek/MoodleGeneral}
\input{Fejezetek/MoodlePlugin}
\input{Fejezetek/Osszefoglalas}
%\input{Fejezetek/Fuggelek}
\input{Fejezetek/Nyilatkozat}
\input{Fejezetek/Koszonetnyilvanitas}
\input{Fejezetek/Irodalomjegyzek}
